...
public class DataUtilityTest {
	...
	public void parseInt8ValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (byte) 2);
	...
	public void parseShortValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (short) 2);
	...
	public void parseIntValueTest(){
		...
		ByteBuffer actualInt32 = new DataUtility().parseValue(schemaInt32, (int) 2);
	...
	public void  parseLongValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (long) 2);
	...
	public void parseFloatValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (float) 2);
	...
	public void parseDoubleValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (double) 2);
	...
	public void parseBooleanValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, (boolean) true);
	...
	public void parseStringValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, "Testing Kinesis-Kafka Connector");
	...
	public void parseArrayValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, arrayOfInt8);
	...
	public void parseByteValueTest(){
		...
		ByteBuffer actual = new DataUtility().parseValue(schema, value);
